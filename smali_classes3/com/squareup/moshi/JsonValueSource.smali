...
.method private advanceLimit(J)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lokio/Buffer;->indexOfElement(Lokio/ByteString;J)J
    ...
    invoke-interface {v2, v7, v8}, Lokio/BufferedSource;->require(J)V
    ...
    .line 143
    iput-wide v7, p0, Lcom/squareup/moshi/JsonValueSource;->limit:J
    ...
    .line 158
    :cond_d
    sget-object v10, Lcom/squareup/moshi/JsonValueSource;->STATE_SINGLE_QUOTED:Lokio/ByteString;

    if-eq v3, v10, :cond_12

    sget-object v10, Lcom/squareup/moshi/JsonValueSource;->STATE_DOUBLE_QUOTED:Lokio/ByteString;
    ...
    .line 178
    iput-object v6, p0, Lcom/squareup/moshi/JsonValueSource;->state:Lokio/ByteString;
