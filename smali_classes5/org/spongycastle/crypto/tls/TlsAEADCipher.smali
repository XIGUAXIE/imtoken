...
.method public decodeCiphertext(JS[BII)[B
    ...
    .line 143
    iget-object v3, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->decryptImplicitNonce:[B
    ...
    invoke-static {v8, v1, v4, v3, v5}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 147
    iget v3, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->nonce_explicit_length:I
    ...
    .line 149
    iget-object v1, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/spongycastle/crypto/modes/AEADBlockCipher;

    invoke-interface {v1, v10}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->getOutputSize(I)I
    ...
    .line 154
    invoke-virtual {p0, p1, p2, v3, v1}, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->getAdditionalData(JSI)[B
    ...
    iget v11, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->macSize:I
    ...
    .line 160
    iget-object v7, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->decryptCipher:Lorg/spongycastle/crypto/modes/AEADBlockCipher;
...
.method public encodePlaintext(JS[BII)[B
    ...
    .line 94
    iget-object v3, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->encryptImplicitNonce:[B

    array-length v5, v3

    iget v6, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->nonce_explicit_length:I
    ...
    invoke-static {p1, p2, v5, v3}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint64(J[BI)V
    ...
    invoke-interface {v3, v4}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->getOutputSize(I)I
    ...
    invoke-static {v5, v3, v9, v7, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 110
    iget v7, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->nonce_explicit_length:I

    move v3, p3

    .line 112
    invoke-virtual {p0, p1, p2, p3, v4}, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->getAdditionalData(JSI)[B
    ...
    iget v3, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->macSize:I

    mul-int/lit8 v3, v3, 0x8

    const/4 v6, 0x0

    invoke-direct {v2, v6, v3, v5, v1}, Lorg/spongycastle/crypto/params/AEADParameters;-><init>(Lorg/spongycastle/crypto/params/KeyParameter;I[B[B)V

    const/16 v10, 0x50

    .line 117
    :try_start_0
    iget-object v1, v0, Lorg/spongycastle/crypto/tls/TlsAEADCipher;->encryptCipher:Lorg/spongycastle/crypto/modes/AEADBlockCipher;
    ...
    invoke-interface {v1, v9, v7}, Lorg/spongycastle/crypto/modes/AEADBlockCipher;->doFinal([BI)I
