...
# virtual methods
.method protected abstract calculateDerivedKey([BLorg/bouncycastle/asn1/x509/AlgorithmIdentifier;I)[B
...
.method public generate(Lorg/bouncycastle/operator/GenericKey;)Lorg/bouncycastle/asn1/cms/RecipientInfo;
    ...
    iget-object v2, p0, Lorg/bouncycastle/cms/PasswordRecipientInfoGenerator;->password:[C

    invoke-static {v1, v2}, Lorg/bouncycastle/cms/CMSUtils;->getPasswordBytes(I[C)[B
    ...
    invoke-virtual {p0, v1, v2, v3}, Lorg/bouncycastle/cms/PasswordRecipientInfoGenerator;->calculateDerivedKey([BLorg/bouncycastle/asn1/x509/AlgorithmIdentifier;I)[B
