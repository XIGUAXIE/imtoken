...
.method private static PKCS5PasswordToUTF8Bytes([C)[B
    .locals 0
...
.method static getPasswordBytes(I[C)[B
    .locals 0

    if-nez p0, :cond_0

    invoke-static {p1}, Lorg/bouncycastle/cms/CMSUtils;->PKCS5PasswordToBytes([C)[B
    ...
    :cond_0
    invoke-static {p1}, Lorg/bouncycastle/cms/CMSUtils;->PKCS5PasswordToUTF8Bytes([C)[B
