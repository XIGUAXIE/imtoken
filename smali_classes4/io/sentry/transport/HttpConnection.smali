...
.method private getErrorMessageFromStream(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    .line 261
    :try_start_3
    invoke-static {v2, v0}, Lio/sentry/transport/HttpConnection;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_3
    ...
    :try_start_4
    invoke-static {v2, p1}, Lio/sentry/transport/HttpConnection;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_4
    ...
    .line 261
    :try_start_6
    invoke-static {v1, v0}, Lio/sentry/transport/HttpConnection;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public send(Lio/sentry/SentryEnvelope;)Lio/sentry/transport/TransportResult;
    ...
    .line 156
    :try_start_3
    invoke-static {p1, v2}, Lio/sentry/transport/HttpConnection;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_2
    ...
    :try_start_4
    invoke-static {p1, v1}, Lio/sentry/transport/HttpConnection;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_4
