...
.method private constructor <init>(Z)V
    ...
    invoke-direct {v2}, Lio/sentry/EnvelopeReader;-><init>()V

    iput-object v2, p0, Lio/sentry/SentryOptions;->envelopeReader:Lio/sentry/IEnvelopeReader;

    .line 84
    new-instance v2, Lio/sentry/GsonSerializer;

    iget-object v3, p0, Lio/sentry/SentryOptions;->logger:Lio/sentry/ILogger;

    iget-object v4, p0, Lio/sentry/SentryOptions;->envelopeReader:Lio/sentry/IEnvelopeReader;

    invoke-direct {v2, v3, v4}, Lio/sentry/GsonSerializer;-><init>(Lio/sentry/ILogger;Lio/sentry/IEnvelopeReader;)V
    ...
    .line 108
    iput v2, p0, Lio/sentry/SentryOptions;->cacheDirSize:I

    .line 111
    iput v2, p0, Lio/sentry/SentryOptions;->maxQueueSize:I
    ...
    .line 199
    iput-wide v2, p0, Lio/sentry/SentryOptions;->sessionTrackingIntervalMillis:J
    ...
    .line 219
    iput v0, p0, Lio/sentry/SentryOptions;->connectionTimeoutMillis:I

    .line 222
    iput v0, p0, Lio/sentry/SentryOptions;->readTimeoutMillis:I
    ...
    iput-object v0, p0, Lio/sentry/SentryOptions;->envelopeDiskCache:Lio/sentry/cache/IEnvelopeCache;

    const/4 v0, 0x0

    .line 231
    iput-boolean v0, p0, Lio/sentry/SentryOptions;->sendDefaultPii:Z
    ...
    iput-object v0, p0, Lio/sentry/SentryOptions;->observers:Ljava/util/List;
    ...
    iput-object v0, p0, Lio/sentry/SentryOptions;->tags:Ljava/util/Map;

    const-wide/32 v2, 0x1400000

    .line 255
    iput-wide v2, p0, Lio/sentry/SentryOptions;->maxAttachmentSize:J

    .line 262
    iput-object v1, p0, Lio/sentry/SentryOptions;->enableDeduplication:Ljava/lang/Boolean;
...
.method private createSdkVersion()Lio/sentry/protocol/SdkVersion;
    ...
    invoke-direct {v0, v2, v1}, Lio/sentry/protocol/SdkVersion;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 1400
    invoke-virtual {v0, v1}, Lio/sentry/protocol/SdkVersion;->setVersion(Ljava/lang/String;)V

    const-string v2, "maven:io.sentry:sentry"

    .line 1401
    invoke-virtual {v0, v2, v1}, Lio/sentry/protocol/SdkVersion;->addPackage(Ljava/lang/String;Ljava/lang/String;)V
