...
.method public constructor <init>(Landroid/content/Context;Lcom/wei/android/lib/fingerprintidentify/base/BaseFingerprint$ExceptionListener;)V
    ...
    invoke-virtual {p0, p1}, Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;->setHardwareEnable(Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;->setRegisteredFingerprint(Z)V
    :try_end_0
    ...
    .line 48
    invoke-virtual {p0, p1}, Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;->onCatchException(Ljava/lang/Throwable;)V
...
.method static synthetic access$000(Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;)V
    ...
    .line 33
    invoke-virtual {p0}, Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;->onSucceed()V
...
.method static synthetic access$100(Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;)V
    ...
    .line 33
    invoke-virtual {p0}, Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;->onNotMatch()V
...
.method private releaseMBack()V
    ...
    .line 86
    invoke-virtual {p0, v0}, Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;->onCatchException(Ljava/lang/Throwable;)V
...
.method protected doIdentify()V
    ...
    .line 71
    invoke-virtual {p0, v0}, Lcom/wei/android/lib/fingerprintidentify/impl/MeiZuFingerprint;->onFailed(Z)V
