...
.method public static addLocalNotification(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/m/d;->a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
...
.method public static clearLocalNotifications(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/m/d;->a(Landroid/content/Context;)V
...
.method public static filterValidTags(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lcn/jpush/android/r/a;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method public static getStringTags(Ljava/util/Set;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcn/jpush/android/r/a;->b(Ljava/util/Set;)Ljava/lang/String;
...
.method public static goToAppNotificationSettings(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/o/b;->e(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lcn/jpush/android/o/b;->f(Landroid/content/Context;)Z
...
.method public static init(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/t/a;->g(Landroid/content/Context;)Z
    ...
    invoke-virtual {v1, p0, v2, v0}, Lcn/jpush/android/local/ActionHelper;->doSingleAction(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static removeLocalNotification(Landroid/content/Context;J)V
    ...
    invoke-static {p0, p1, p2}, Lcn/jpush/android/m/d;->a(Landroid/content/Context;J)V
...
.method public static setBadgeNumber(Landroid/content/Context;I)V
    ...
    const-string/jumbo v1, "set_badge"
...
.method public static setDefaultPushNotificationBuilder(Lcn/jpush/android/api/PushNotificationBuilder;)V
    ...
    const-string/jumbo v2, "set_custom_notify"
...
.method public static setPushNotificationBuilder(Ljava/lang/Integer;Lcn/jpush/android/api/PushNotificationBuilder;)V
    ...
    const-string/jumbo v1, "set_custom_notify"
...
.method public static setPushTime(Landroid/content/Context;Ljava/util/Set;II)V
    ...
    invoke-static {p0}, Lcn/jpush/android/t/a;->a(Landroid/content/Context;)Z
...
.method public static setSilenceTime(Landroid/content/Context;IIII)V
    ...
    :cond_0
    const-string/jumbo v1, "silenceTime"
