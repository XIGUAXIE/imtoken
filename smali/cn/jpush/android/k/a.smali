...
.method private static a(Landroid/content/Context;IJ)V
    ...
    invoke-virtual {p1, p0, p2, p3}, Lcn/jpush/android/s/a;->b(Landroid/content/Context;J)V
    ...
    :cond_0
    :pswitch_2
    invoke-static {}, Lcn/jpush/android/r/b;->a()Lcn/jpush/android/r/b;

    move-result-object p1

    invoke-virtual {p1, p2, p3}, Lcn/jpush/android/r/b;->a(J)I

    move-result p1

    sget v0, Lcn/jpush/android/api/JPushInterface$ErrorCode;->TIMEOUT:I

    invoke-static {p0, p1, v0, p2, p3}, Lcn/jpush/android/r/a;->a(Landroid/content/Context;IIJ)V
...
.method private static a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {p0, v1}, Lcn/jpush/android/o/b;->c(Landroid/content/Context;I)V
...
.method private static a(Landroid/content/Context;Lcn/jpush/android/local/JPushResponse;)V
    ...
    invoke-direct {v0, p1}, Lcn/jpush/android/q/a;-><init>(Lcn/jpush/android/local/JPushResponse;)V

    invoke-virtual {v0}, Lcn/jpush/android/q/a;->a()I
    ...
    invoke-virtual {v0, p0, v1, v2}, Lcn/jpush/android/s/a;->a(Landroid/content/Context;J)V
    ...
    invoke-virtual {v1, p0, v2, v3, p1}, Lcn/jpush/android/s/a;->a(Landroid/content/Context;JI)V
    ...
    invoke-virtual {v0}, Lcn/jpush/android/q/a;->getRquestId()J
    ...
    :pswitch_4
    invoke-static {p0, v4, v3}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;IZ)V
    ...
    :cond_1
    :pswitch_7
    new-instance v0, Lcn/jpush/android/q/e;

    invoke-direct {v0, p1}, Lcn/jpush/android/q/e;-><init>(Lcn/jpush/android/local/JPushResponse;)V

    invoke-virtual {v0}, Lcn/jpush/android/q/e;->a()Ljava/lang/String;
    ...
    invoke-static {p0, v0, v3, v1, v2}, Lcn/jpush/android/r/a;->a(Landroid/content/Context;Ljava/lang/String;IJ)J
    ...
    invoke-direct {v0, p1}, Lcn/jpush/android/q/c;-><init>(Lcn/jpush/android/local/JPushResponse;)V
    ...
    invoke-virtual {v0}, Lcn/jpush/android/q/c;->a()I
    ...
    :cond_4
    invoke-static {p0, v0}, Lcn/jpush/android/d/b;->a(Landroid/content/Context;Lcn/jpush/android/q/c;)V
...
.method private static a(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, v5}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :try_start_1
    invoke-static {v5, v3}, Lcn/jpush/android/o/b;->a(Ljava/lang/String;I)I
    ...
    invoke-static {p0, v6}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;I)Z

    move-result v7

    if-eqz v7, :cond_4

    invoke-static {p0, v6}, Lcn/jpush/android/o/b;->d(Landroid/content/Context;I)V
    ...
    invoke-static {p0, v5, v6}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, p0, v5}, Lcn/jpush/android/s/c;->a(Landroid/content/Context;Ljava/lang/String;)B
    ...
    :cond_6
    invoke-static {p0, v1}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;Ljava/util/List;)V
    :try_end_1
...
.method private a(Landroid/content/Context;)Z
    ...
    invoke-static {p1}, Lcn/jpush/android/t/a;->g(Landroid/content/Context;)Z
...
.method private b(Landroid/content/Context;)V
    ...
    sget v5, Lcn/jpush/android/local/JPushConstants;->SDK_VERSION_CODE:I
    ...
    invoke-static {}, Lcn/jpush/android/o/e;->a()Lcn/jpush/android/o/e;

    move-result-object v0

    const/4 v2, 0x0

    invoke-virtual {v0, p1, v2}, Lcn/jpush/android/o/e;->a(Landroid/content/Context;Lcn/jpush/android/o/e$a;)V

    const-string/jumbo v0, "push"

    sget v2, Lcn/jpush/android/l/a;->a:I

    invoke-static {p1, v0, v1, v3, v2}, Lcn/jpush/android/helper/JCoreHelper;->reportSdkType(Landroid/content/Context;Ljava/lang/String;III)V
...
.method public beforLogin(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, p1}, Lcn/jpush/android/s/c;->e(Landroid/content/Context;)B
    ...
    :cond_2
    const-string/jumbo p2, "platformregid"
    ...
    invoke-virtual {p2, p1}, Lcn/jpush/android/s/c;->f(Landroid/content/Context;)Ljava/lang/String;
...
.method public handleAction(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string/jumbo v5, "ups.turnOn"
    ...
    const-string/jumbo v11, "set failed"

    const-string/jumbo v12, "set success"
    ...
    invoke-static {v9, v2, v13, v11}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;IILjava/lang/String;)V

    return-object v6

    :cond_5
    invoke-static {v9, v2, v14, v12}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;IILjava/lang/String;)V
    ...
    invoke-static {v9}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;)V
    ...
    :cond_c
    const-string/jumbo v10, "set_mobile"
    ...
    :cond_d
    const-string/jumbo v10, "pushtime"
    ...
    :cond_e
    const-string/jumbo v10, "silenceTime"
    ...
    :cond_12
    const-string/jumbo v10, "third_enable"
    ...
    invoke-static {v9}, Lcn/jpush/android/t/a;->c(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "third enable:"
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/s/c;->i(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/s/c;->g(Landroid/content/Context;)V
    ...
    :cond_16
    const-string/jumbo v10, "set_badge"
    ...
    invoke-static {v9, v6, v0, v0}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Landroid/app/Notification;II)Z
    ...
    :cond_19
    const-string/jumbo v10, "tagalis"
    ...
    invoke-static {v9, v8}, Lcn/jpush/android/r/a;->a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {v9}, Lcn/jpush/android/m/a;->a(Landroid/content/Context;)Lcn/jpush/android/m/a;

    move-result-object v2

    invoke-virtual {v2, v9, v0}, Lcn/jpush/android/m/a;->a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)Z

    goto/16 :goto_b

    :cond_1b
    const-string/jumbo v10, "rm_local_notify"
    ...
    invoke-virtual {v0, v9, v2, v3}, Lcn/jpush/android/m/a;->a(Landroid/content/Context;J)Z
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/m/a;->b(Landroid/content/Context;)V

    goto/16 :goto_b

    :cond_1d
    const-string/jumbo v10, "show_local_notify"
    ...
    const-string/jumbo v0, "push has stoped"
    ...
    invoke-static {v9, v0}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    :cond_20
    const-string/jumbo v10, "set_custom_notify"
    ...
    :cond_21
    const-string/jumbo v10, "third_push_upload_regid"
    ...
    invoke-virtual {v0, v9, v8}, Lcn/jpush/android/s/c;->a(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    invoke-static {v9, v13, v14}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;IZ)V
    ...
    :goto_7
    invoke-static {v9, v2, v0, v3}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;IILjava/lang/String;)V
    ...
    :goto_8
    invoke-static {v9, v2, v3, v0}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;IILjava/lang/String;)V
    ...
    invoke-static {v9, v2, v14, v0}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;IILjava/lang/String;)V
    ...
    const-string/jumbo v12, "ups.unregister"
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/m/a;->d(Landroid/content/Context;)V
    ...
    :cond_36
    invoke-static {v9, v0, v2, v3}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;IILjava/lang/String;)V
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/s/c;->h(Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "onEvent failed:"
    ...
    :goto_a
    invoke-virtual {v2, v9, v0}, Lcn/jpush/android/s/c;->b(Landroid/content/Context;Landroid/os/Bundle;)V

    goto/16 :goto_b

    :cond_3a
    const-string/jumbo v2, "third_init"
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/s/c;->b(Landroid/content/Context;)V

    goto/16 :goto_b

    :cond_3b
    const-string/jumbo v2, "third_resume"
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/s/c;->c(Landroid/content/Context;)V

    goto/16 :goto_b

    :cond_3c
    const-string/jumbo v2, "third_stop"
    ...
    invoke-virtual {v0, v9}, Lcn/jpush/android/s/c;->d(Landroid/content/Context;)V

    goto/16 :goto_b

    :cond_3d
    const-string/jumbo v2, "third_action"
    ...
    invoke-virtual {v2, v9, v0, v8}, Lcn/jpush/android/s/c;->a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v9, v6}, Lcn/jpush/android/o/e;->a(Landroid/content/Context;Lcn/jpush/android/o/e$a;)V
...
.method public handleNotificationIntent(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p1, p2}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/d/d;
    ...
    iget-byte v1, v0, Lcn/jpush/android/d/d;->ab:B
    ...
    iget-byte v3, v0, Lcn/jpush/android/d/d;->ab:B

    invoke-static {p1, v1, v3}, Lcn/jpush/android/api/JPushInterface;->reportNotificationOpened(Landroid/content/Context;Ljava/lang/String;B)V

    :goto_0
    invoke-static {p1, v0}, Lcn/jpush/android/o/b;->c(Landroid/content/Context;Lcn/jpush/android/d/d;)I
    ...
    invoke-static {p1, v0}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {p1, v1, v0, p2}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V
...
.method public onTagAliasResponse(Landroid/content/Context;JILandroid/content/Intent;)V
    ...
    invoke-static {}, Lcn/jpush/android/r/c;->a()Lcn/jpush/android/r/c;
    ...
    invoke-virtual/range {v0 .. v5}, Lcn/jpush/android/r/c;->a(Landroid/content/Context;JILandroid/content/Intent;)V
...
.method public setAliasAndTags(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lcn/jpush/android/api/CallBackParams;)V
    ...
    invoke-static {p1, p2, p3, p4}, Lcn/jpush/android/r/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lcn/jpush/android/api/CallBackParams;)V
