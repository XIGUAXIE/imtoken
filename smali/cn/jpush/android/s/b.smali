...
.method private static a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {p0, v1, p1}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
    ...
    :cond_0
    invoke-static {p0, v1, p1}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;)Landroid/content/Intent;
...
.method private static a(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V
    ...
    invoke-static {p0, p3, p1, v0}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IBI)V
    ...
    invoke-static {p0, p1, p2}, Lcn/jpush/android/s/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcn/jpush/android/d/d;
    ...
    :cond_3
    iput-byte p4, p1, Lcn/jpush/android/d/d;->ab:B
    ...
    :cond_4
    invoke-static {p0, p1, p2, p3}, Lcn/jpush/android/s/b;->b(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V

    goto :goto_1

    :cond_5
    invoke-static {p0, p1, p2, p3}, Lcn/jpush/android/s/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V

    goto :goto_1

    :cond_6
    invoke-static {p0, p1, p2, p3}, Lcn/jpush/android/s/b;->c(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V
    ...
    invoke-static {p0, p2}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;Ljava/util/List;)V
...
.method private static c(Landroid/content/Context;Lcn/jpush/android/d/d;Ljava/lang/String;I)V
    ...
    iget-boolean p3, p1, Lcn/jpush/android/d/d;->R:Z
    ...
    invoke-static {p0, v0, p1, p3}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Ljava/lang/String;Lcn/jpush/android/d/d;Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-static {p0, p1}, Lcn/jpush/android/s/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
