...
.method public static a(Landroid/content/Intent;)Lcn/jpush/android/api/CustomMessage;
    ...
    const-string/jumbo v2, "processMessage failed:"
...
.method private static a(Landroid/content/Context;IJJ)V
    ...
    invoke-static {v0, p1, p2, p3}, Lcn/jpush/android/q/b;->a(IBJ)[B
...
.method public static a(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;JB)V
    ...
    :cond_2
    iget-object p2, p1, Lcn/jpush/android/d/d;->c:Ljava/lang/String;

    iget-object p3, p1, Lcn/jpush/android/d/d;->f:Ljava/lang/String;

    invoke-static {p0, p2, p3}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_3
    iput-byte p7, p1, Lcn/jpush/android/d/d;->ab:B
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    const-string/jumbo v1, "processBasicEntity type:"
    ...
    const-string/jumbo v0, "processBasicEntity user-defined message."
    ...
    const-string/jumbo v0, "processBasicEntity notification"
    ...
    invoke-static {p0}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;)Z
    ...
    const-string/jumbo p0, "push is invalidPushTime\uff0cIntercept the message"
    ...
    invoke-static {p0, v0}, Lcn/jpush/android/o/d;->b(Landroid/content/Context;Ljava/lang/String;)V

    invoke-static {p0, p1}, Lcn/jpush/android/o/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;)V

    :cond_7
    return-void
.end method

.method public static a(Landroid/content/Context;Lcn/jpush/android/q/c;)V
    .locals 14

    invoke-virtual {p1}, Lcn/jpush/android/q/c;->a()I

    move-result v1

    invoke-virtual {p1}, Lcn/jpush/android/q/c;->b()J

    move-result-wide v2

    invoke-virtual {p1}, Lcn/jpush/android/q/c;->getRid()J
    ...
    invoke-virtual {p1}, Lcn/jpush/android/q/c;->c()Ljava/lang/String;
    ...
    const-string/jumbo p0, "unkown msg type"
    ...
    invoke-static {p0, v8, p1, v2, v3}, Lcn/jpush/android/r/a;->a(Landroid/content/Context;Ljava/lang/String;IJ)J
...
.method public static b(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {p0, v2}, Lcn/jpush/android/t/a;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-byte v0, p1, Lcn/jpush/android/d/d;->ab:B
    ...
    iget-byte p1, p1, Lcn/jpush/android/d/d;->ab:B
    ...
    const-string/jumbo v0, "sendBroadcastToApp error:"
