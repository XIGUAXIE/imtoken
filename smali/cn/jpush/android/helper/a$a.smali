...
.method public constructor <init>(Lcn/jpush/android/helper/a;Landroid/content/Context;Lcn/jpush/android/service/JPushMessageReceiver;Landroid/content/Intent;)V
    ...
    iput-object p1, p0, Lcn/jpush/android/helper/a$a;->e:Ljava/lang/String;
...
.method public a()V
    ...
    const-string/jumbo v2, "unsupport action type"
    ...
    invoke-virtual {v2, v5, v6}, Lcn/jpush/android/r/c;->a(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/JPushMessage;
    ...
    const-string/jumbo v1, "parse tagalias message failed"
    ...
    :cond_7
    const-string/jumbo v1, "unsupport message type"
    ...
    invoke-static {v3, v4}, Lcn/jpush/android/t/a;->e(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/NotificationMessage;
    ...
    invoke-static {v0, v1}, Lcn/jpush/android/o/b;->b(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/NotificationMessage;
    ...
    :cond_11
    const-string/jumbo v3, "on_noti_settings_check"
