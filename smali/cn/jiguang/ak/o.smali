.class public final Lcn/jiguang/ak/o;
...
.method public constructor <init>(J)V
    ...
    iput-wide p1, p0, Lcn/jiguang/ak/o;->a:J
    ...
    iput-object p2, p0, Lcn/jiguang/ak/o;->b:Ljava/nio/channels/SelectionKey;
    :try_end_1
...
.method private a(I)[B
    ...
    iget-object v0, p0, Lcn/jiguang/ak/o;->b:Ljava/nio/channels/SelectionKey;
    ...
    iget-object v3, p0, Lcn/jiguang/ak/o;->b:Ljava/nio/channels/SelectionKey;
    ...
    :try_start_0
    iget-object v5, p0, Lcn/jiguang/ak/o;->b:Ljava/nio/channels/SelectionKey;
    ...
    iget-wide v7, p0, Lcn/jiguang/ak/o;->a:J
    ...
    iget-wide v6, p0, Lcn/jiguang/ak/o;->a:J

    invoke-static {v5, v6, v7}, Lcn/jiguang/ak/o;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_0
    ...
    :cond_5
    iget-object p1, p0, Lcn/jiguang/ak/o;->b:Ljava/nio/channels/SelectionKey;
...
.method public static a(Ljava/net/SocketAddress;Ljava/net/SocketAddress;[BJ)[B
    ...
    new-instance v0, Lcn/jiguang/ak/o;

    invoke-direct {v0, p3, p4}, Lcn/jiguang/ak/o;-><init>(J)V

    if-eqz p0, :cond_0

    :try_start_0
    invoke-virtual {v0, p0}, Lcn/jiguang/ak/o;->a(Ljava/net/SocketAddress;)V

    :cond_0
    invoke-virtual {v0, p1}, Lcn/jiguang/ak/o;->b(Ljava/net/SocketAddress;)V

    invoke-virtual {v0, p2}, Lcn/jiguang/ak/o;->a([B)V

    invoke-virtual {v0}, Lcn/jiguang/ak/o;->a()[B

    move-result-object p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v0}, Lcn/jiguang/ak/o;->b()V
...
.method a([B)V
    ...
    iget-object v2, p0, Lcn/jiguang/ak/o;->b:Ljava/nio/channels/SelectionKey;
...
.method a()[B
    ...
    invoke-direct {p0, v0}, Lcn/jiguang/ak/o;->a(I)[B
    ...
    invoke-direct {p0, v1}, Lcn/jiguang/ak/o;->a(I)[B

    move-result-object v0

    iget-object v1, p0, Lcn/jiguang/ak/o;->b:Ljava/nio/channels/SelectionKey;
...
.method b(Ljava/net/SocketAddress;)V
    ...
    iget-wide v2, p0, Lcn/jiguang/ak/o;->a:J

    invoke-static {v1, v2, v3}, Lcn/jiguang/ak/o;->a(Ljava/nio/channels/SelectionKey;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
