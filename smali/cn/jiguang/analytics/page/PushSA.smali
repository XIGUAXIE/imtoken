...
.method private clearCurrentLogFile(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "push_stat_cache.json"

    const/4 v1, 0x0

    invoke-static {p1, v0, v1}, Lcn/jiguang/ag/f;->a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)Z
...
.method private generateSessionID(Landroid/content/Context;J)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcn/jiguang/f/f;->d(Ljava/lang/String;)Ljava/lang/String;
...
.method private invokeCheck(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v2, p1}, Lcn/jiguang/af/c;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, p1}, Lcn/jiguang/af/c;->j(Ljava/lang/String;Ljava/lang/String;)V
...
.method private isNewSession(Landroid/content/Context;)Z
    ...
    const-string/jumbo v5, "statistics start"
...
.method private saveCurrentLog(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-static {p1, v0, p2}, Lcn/jiguang/ag/f;->a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)Z
...
.method public onFragmentPause(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0}, Lcn/jiguang/as/d;->a(Ljava/lang/String;Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_1
    const-string/jumbo p1, "page name didn\'t match the last one passed by onResume"

    invoke-static {v1, p1}, Lcn/jiguang/af/c;->j(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onPause(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lcn/jiguang/af/c;->e(Ljava/lang/String;Ljava/lang/String;)V
